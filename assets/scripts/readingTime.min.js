! function(e) {
  e.fn.readingTime = function(n) {
    ...
    if ("fr" == d) var T = l || "Moins d'une minute",
      v = "min";
    else if ("de" == d) var T = l || "Weniger als eine Minute",
      v = "min";
    else if ("es" == d) var T = l || "Menos de un minuto",
      v = "min";
    else if ("nl" == d) var T = l || "Minder dan een minuut",
      v = "min";
    else var T = l || "Less than a minute",
      v = "min";
    var M = function(e) {
    ...
    r.each(function() {
      null != f && null != h ? e.get(f, function(n) {
